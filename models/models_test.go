...
func TestDiscountType_JSON(t *testing.T) {
	...
	json.Unmarshal(data, &decoded)
	assert.Equal(t, "Seasonal", decoded.TypeName)
}
...
func TestUnitType_JSON(t *testing.T) {
	...
	json.Unmarshal(data, &decoded)
	assert.Equal(t, "PCS", decoded.TypeName)
}
...
func TestProductFormatType_JSON(t *testing.T) {
	...
	json.Unmarshal(data, &decoded)
	assert.Equal(t, "Hardcover", decoded.TypeName)
}
...
func TestProductGroup_JSON(t *testing.T) {
	...
	json.Unmarshal(data, &decoded)
	assert.Equal(t, "Books", decoded.GroupName)
}
